...
class AttachmentsControllerTest < ActionController::TestCase
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post :create, attachment: { file: @attachment.file, num_queue: @attachment.num_queue, user_id: @attachment.user_id }
    end
  ...
  test "should update attachment" do
    patch :update, id: @attachment, attachment: { file: @attachment.file, num_queue: @attachment.num_queue, user_id: @attachment.user_id }
    assert_redirected_to attachment_path(assigns(:attachment))
  end
